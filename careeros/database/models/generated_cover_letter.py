...
class GeneratedCoverLetter(Base, TimestampMixin):
    __tablename__ = "generated_cover_letters"
    __table_args__ = (
        UniqueConstraint("session_id", "version_number", name="uq_cl_session_version"),
    )
    ...
    # Relationships
    session: Mapped["GenerationSession"] = relationship("GenerationSession", back_populates="cover_letters", foreign_keys=[session_id])
